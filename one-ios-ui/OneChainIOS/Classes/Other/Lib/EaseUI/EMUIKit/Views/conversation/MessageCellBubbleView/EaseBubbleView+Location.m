...
//    NSLayoutConstraint *marginWidthConstraint = [NSLayoutConstraint constraintWithItem:self.locationImageView attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeWidth multiplier:1 constant:150];
...
- (void)_setupLocationBubbleConstraints
{
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.locationLabel attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:self.locationImageView attribute:NSLayoutAttributeHeight multiplier:0.2 constant:0]];
}
...
- (void)setupLocationBubbleView
{
    ...
    self.locationImageView.layer.cornerRadius = 8.f;
