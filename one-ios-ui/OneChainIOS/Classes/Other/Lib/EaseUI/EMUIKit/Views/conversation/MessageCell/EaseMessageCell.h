...
#define kEMMessageImageSizeHeight 160
...
@property (strong, nonatomic) NSDictionary *sendBubbleBackgroundImageDic UI_APPEARANCE_SELECTOR;

@property (nonatomic, strong) NSDictionary *recvBubbleBackgroundImageDic UI_APPEARANCE_SELECTOR;
...
- (void)avatarViewPressed:(id<IMessageModel>)model;
