...
-(NSString *)monthFormattedTime
{
    [NSTimeZone setDefaultTimeZone:[NSTimeZone systemTimeZone]];
    
    NSDateFormatter* formatter = [[NSDateFormatter alloc]init];
    [formatter setDateFormat:@"YYYY-MM-dd"];
    NSString * dateNow = [formatter stringFromDate:[ONEChatClient date]];
...
- (NSString *)formattedDateDescription
{
	...
	NSString *theDay = [dateFormatter stringFromDate:self];
	NSString *currentDay = [dateFormatter stringFromDate:[ONEChatClient date]];
    
    NSInteger timeInterval = /**-[self timeIntervalSinceNow]*/-[self timeIntervalSinceDate:[ONEChatClient date]];
    if (timeInterval < 60) {
        return NSEaseLocalizedString(@"NSDateCategory.text1", @"");
