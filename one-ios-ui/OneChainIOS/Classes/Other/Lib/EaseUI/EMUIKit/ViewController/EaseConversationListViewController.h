...
#import <WalletCore/ONEChatClient.h>
...
- (BOOL)conversationListViewController:(EaseConversationListViewController *)conversationListViewController canEditModel:(id<IConversationModel>)conversationModel;
...
@interface EaseConversationListViewController : EaseRefreshTableViewController <ONEChatClientDelegate>
