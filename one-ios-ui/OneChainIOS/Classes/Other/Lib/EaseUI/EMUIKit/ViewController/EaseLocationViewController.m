...
- (void)viewDidLoad
{
    ...
    self.title = NSLocalizedString(@"attach_location", @"");
...
//    [self.navigationItem setLeftBarButtonItem:backItem];
    ...
    if (_isSendLocation) {
        ...
        [sendButton setTitle:NSLocalizedString(@"button_send", @"Send") forState:UIControlStateNormal];
        [sendButton setTitleColor:DEFAULT_BLACK_COLOR forState:UIControlStateNormal];
        [sendButton setTitleColor:DEFAULT_BLACK_COLOR forState:UIControlStateHighlighted];
...
- (void)startLocation
{
    ...
    [self showHudInView:self.view hint:NSLocalizedString(@"Making_sure_your_location", @"")];
}
