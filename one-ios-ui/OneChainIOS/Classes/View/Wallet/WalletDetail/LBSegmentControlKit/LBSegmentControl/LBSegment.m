...
//    self.titleLabel.textColor = titleNormalColor;
    if (self.is_trade) {
        self.titleLabel.themeMap = @{
                                     TextColorName:@"segment_trade_text_color"
                                     };
    } else {
        self.titleLabel.themeMap = @{
                                     TextColorName:@"segment_text_color"
                                     };
    }
...
- (void)setTitle:(NSString *)title {
    if (_title.length == 0) {
        ...
        self.titleLabel.font = [UIFont fontWithName:FONT_NAME_LIGHT size:14.f];
...
//                                     };
        if (self.is_trade) {
            self.titleLabel.themeMap = @{
                                         TextColorName:@"segment_trade_select_text_color"
                                         };
        } else {
            self.titleLabel.themeMap = @{
                                         TextColorName:@"segment_select_text_color"
                                         };
        }
...
//        return;
//    }
        self.titleLabel.font = [UIFont fontWithName:FONT_NAME_MEDIUM size:14.f];
    // 缩放比例
