...
*/
    ...
    //AppKey
    #define MOBSSDKSinaWeiboAppKey @"2086560360"
    //AppSecret
    #define MOBSSDKSinaWeiboAppSecret @"7ff981295c84856788cde3e9f12b0cc6"
    //RedirectUri
...
*/
    ...
    //AppID
    #define MOBSSDKWeChatAppID @"wxf17278d4d668cfd6"
    //AppSecret
    #define MOBSSDKWeChatAppSecret @"3d7d82079ab04549d3c64a6c7ce06f09"
    //是否默认返回 UnionID v4.0.2增加
...
*/
    ...
    #define MOBSSDKFacebookDisplayName @"One"
    //AuthType 授权优先类型 web sso both
