...
@property(nonatomic, readonly) NSData* unsignedBigEndianPlus;
...
- (id) initWithBigNumber:(BTCBigNumber* )otherNum;
...
@property(nonatomic, readwrite) NSString* hexStringAndFlag;
...
- (id) initWithDouble:(double) value lshiftDec:(int) l;

- (id) initWithDecimalNumber:(NSDecimalNumber*) number;



- (id) initWithString:(NSString*) value lshiftDec:(int) l;
-(NSString*) stringWithRShiftDec:(int) r;
...
- (instancetype) lshiftForDecimalist:(unsigned int)shift; // *= 10^shift
- (instancetype) rshiftForDecimalist:(unsigned int)shift; // /= 10^shift
- (double) rshiftForDecimalistToDouble:(unsigned int)shift; // /= 10^shift
